...
namespace API_livechat.Repositories
{
    public class ChatRoomRepository : IChatRoomRepository
    {
        ...
        public ChatRoomRepository(IConfiguration configuration, ILogger<ChatRoomRepository> logger, MessageRepository messageRepository, DbLoginContext dbContext)
        {
            this._logger = logger;
        ...
        public List<ChatRoom>? GetRoomsByUser(string username)
        {
            try
            {
                ...
                if (GetChatRooms() != null)
                {
                    ...
                    _dbContext.UserProfiles.FirstOrDefault(c => c.ChatRoomsCode == cr_codes);
            ...
            try
            {
                ...
                foreach (UserProfile userProfile in users)
                {
                    if (userProfile.Username == user)
                    {
                        ...
                        _dbContext.UserProfiles.SingleOrDefault(c => c.ChatRoomsCode == userProfile.ChatRoomsCode);
